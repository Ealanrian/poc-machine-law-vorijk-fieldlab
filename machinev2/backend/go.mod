module github.com/Ealanrian/poc-machine-law-vorijk-fieldlab/machinev2/backend
...
require (
	...
	github.com/Ealanrian/poc-machine-law-vorijk-fieldlab/machinev2/machine v0.0.0-20251104122153-af7c2e651b8b
